...
namespace DelegateExamples
{
    ...
    static class Delegates
    {
        static void Main()
        {
            ...
            ApplyToS(strings, s => Console.WriteLine(s));
        }
        ...
        /// <summary>
        /// Applies the method to each element of list.
        /// </summary>
        static void ApplyToS(List<string> list, Action<string> method)
        {
            foreach (string s in list)
            {
                method(s);
        ...
        /// its use.
        /// </summary>
        delegate int Combiner(int n, int m);
        ...
        /// </summary>
        static int Fold (List<int> list, Combiner f, int identity)
        {
            int result = identity;
